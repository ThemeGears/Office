...
$_lang['office_auth_err_user_active'] = 'Вы еще не активировали свой аккаунт';
$_lang['office_auth_err_user_exists'] = 'Пользователь с таким email уже существует';
